...
html_logo = 'images/easynav_logo.png'
html_favicon = 'images/easynav_48x48.png'
...
extlinks = {'projectfile':
    ('https://github.com/EasyNavigation/EasyNavigation/blob/main/%s', 'filepath ')}
